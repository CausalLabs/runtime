...
public class RequestOptions {
    ...
    static public class Builder {
        ...
        /**
         * Should the impression server stifle an error if an impression with the given impression
         * ID is not found. Should be set when the impression id we are signalling on may not exist
         * in Causal to stifle log errors
         * 
         * @param x
         * @return
         */
